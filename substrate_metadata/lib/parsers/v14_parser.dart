...
class V14Parser {
  ...
  ChainInfo getChainInfo() {
    ...
    // Register Era early so relay chains that reference it inside pallet
    // type definitions don't throw "Type not found for `Era`".
...

    {
      ...
      // Era is already registered early above — this is a no-op but kept
      // for clarity in case the registry deduplicates safely.
      _resultingRegistry.addCodec('Era', EraExtrinsic.codec);
