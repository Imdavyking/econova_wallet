...
use crate::utils::field::Fr;
use crate::utils::types::{RelationParameters, Wire, NUMBER_OF_SUBRELATIONS};
use core::ops::Index;
...
mod tests {
    ...
    fn test_relations_determinism() {
        ...
        let mut purported_evaluations =
            Fr::zero_array::<{ crate::utils::types::NUMBER_OF_ENTITIES }>(&env);
        ...
        let mut alphas = Fr::zero_array::<{ crate::utils::types::NUMBER_OF_ALPHAS }>(&env);
        ...
        assert_eq!(
            result.to_bytes(),
            crate::utils::debug::hex_to_bytes(
