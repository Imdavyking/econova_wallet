...
List<CosmosCoin> getCosmosBlockChains() {
  ...
  if (enableTestNet) {
    blockChains.addAll([
      ...
      CosmosCoin(
        blockExplorer:
            'https://explorer.burnt.com/xion-testnet-1/$blockExplorerPlaceholder',
        symbol: 'XION',
        name: 'XION(Test)',
        default_: 'XION',
        image: 'assets/xion.png',
        bech32Hrp: 'xion',
        lcdUrl: 'https://rpc.xion-testnet-1.burnt.com',
        grpcUrl: 'https://grpc.xion-testnet-1.burnt.com',
        path: "m/44'/118'/0'/0/0",
        coinDecimals: 6,
    ...
    blockChains.addAll([
      ...
      CosmosCoin(
        blockExplorer:
            'https://www.mintscan.io/stargaze/txs/$blockExplorerPlaceholder',
        symbol: 'STARS',
        name: 'Stargaze',
        default_: 'STARS',
        image: 'assets/stargaze.png',
        bech32Hrp: 'stars',
        lcdUrl: 'https://stargaze-lcd.polkachu.com',
        grpcUrl: 'stargaze-grpc.polkachu.com',
        path: "m/44'/118'/0'/0/0",
        coinDecimals: 6,
        chainId: 'stargaze-1',
        denom: 'ustars',
...
// Celestia
      CosmosCoin(
        blockExplorer:
            'https://www.mintscan.io/celestia/txs/$blockExplorerPlaceholder',
        symbol: 'TIA',
        name: 'Celestia',
        default_: 'TIA',
        image: 'assets/celestia.png',
        bech32Hrp: 'celestia',
        lcdUrl: 'https://celestia-lcd.polkachu.com',
        grpcUrl: 'celestia-grpc.polkachu.com',
        path: "m/44'/118'/0'/0/0",
        coinDecimals: 6,
        chainId: 'celestia',
        denom: 'utia',
...
// dYdX
      CosmosCoin(
        blockExplorer:
            'https://www.mintscan.io/dydx/txs/$blockExplorerPlaceholder',
        symbol: 'DYDX',
        name: 'dYdX',
        default_: 'DYDX',
        image: 'assets/dydx.png',
        bech32Hrp: 'dydx',
        lcdUrl: 'https://dydx-dao-api.polkachu.com',
        grpcUrl: 'dydx-dao-grpc.polkachu.com',
        path: "m/44'/118'/0'/0/0",
        coinDecimals: 18,
...
// Kujira
      CosmosCoin(
        blockExplorer:
            'https://www.mintscan.io/kujira/txs/$blockExplorerPlaceholder',
        symbol: 'KUJI',
        name: 'Kujira',
        default_: 'KUJI',
        image: 'assets/kujira.png',
        bech32Hrp: 'kujira',
        lcdUrl: 'https://kujira-lcd.polkachu.com',
        grpcUrl: 'kujira-grpc.polkachu.com',
        path: "m/44'/118'/0'/0/0",
        coinDecimals: 6,
        chainId: 'kaiyo-1',
        denom: 'ukuji',
...
// Secret
      CosmosCoin(
        blockExplorer:
            'https://mintscan.io/secret/txs/$blockExplorerPlaceholder',
        symbol: 'SCRT',
        name: 'Secret',
        default_: 'SCRT',
        ...
        grpcUrl: 'grpc.mainnet.secretsaturn.net',
        path: "m/44'/529'/0'/0/0",
        coinDecimals: 6,
        chainId: 'secret-4',
        denom: 'uscrt',
...
// Kava
      CosmosCoin(
        blockExplorer: 'https://mintscan.io/kava/txs/$blockExplorerPlaceholder',
        symbol: 'KAVA',
        name: 'Kava',
        default_: 'KAVA',
        image: 'assets/kava.png',
        bech32Hrp: 'kava',
        lcdUrl: 'https://kava-lcd.polkachu.com',
        grpcUrl: 'kava-grpc.polkachu.com',
        path: "m/44'/459'/0'/0/0",
        coinDecimals: 6,
...
// Neutron
      CosmosCoin(
        blockExplorer:
            'https://www.mintscan.io/neutron/txs/$blockExplorerPlaceholder',
        symbol: 'NTRN',
        name: 'Neutron',
        default_: 'NTRN',
        image: 'assets/neutron.png',
        bech32Hrp: 'neutron',
        lcdUrl: 'https://neutron-lcd.polkachu.com',
        grpcUrl: 'neutron-grpc.polkachu.com',
        path: "m/44'/118'/0'/0/0",
        coinDecimals: 6,
        chainId: 'neutron-1',
        denom: 'untrn',
...
// Sei
      CosmosCoin(
        blockExplorer:
            'https://www.mintscan.io/sei/txs/$blockExplorerPlaceholder',
        symbol: 'SEI',
        name: 'Sei',
        default_: 'SEI',
        image: 'assets/sei.png',
        bech32Hrp: 'sei',
        lcdUrl: 'https://sei-lcd.polkachu.com',
        grpcUrl: 'sei-grpc.polkachu.com',
        path: "m/44'/118'/0'/0/0",
        coinDecimals: 6,
        chainId: 'pacific-1',
        denom: 'usei',
...
// THORChain
      CosmosCoin(
        blockExplorer:
            'https://viewblock.io/thorchain/tx/$blockExplorerPlaceholder',
        symbol: 'RUNE',
        name: 'THORChain',
        default_: 'RUNE',
        image: 'assets/thorchain.png',
        bech32Hrp: 'thor',
        lcdUrl: 'https://thornode.ninerealms.com',
        grpcUrl: 'thornode.ninerealms.com',
        path: "m/44'/931'/0'/0/0",
        coinDecimals: 8,
...
// Axelar
      CosmosCoin(
        blockExplorer:
            'https://www.mintscan.io/axelar/txs/$blockExplorerPlaceholder',
        symbol: 'AXL',
        name: 'Axelar',
        default_: 'AXL',
        image: 'assets/axelar.png',
        bech32Hrp: 'axelar',
        lcdUrl: 'https://axelar-lcd.polkachu.com',
        grpcUrl: 'axelar-grpc.polkachu.com',
        path: "m/44'/118'/0'/0/0",
        coinDecimals: 6,
...
// Terra Classic
      CosmosCoin(
        blockExplorer:
            'https://finder.terra.money/classic/tx/$blockExplorerPlaceholder',
        symbol: 'LUNC',
        name: 'Terra Classic',
        default_: 'LUNC',
        ...
        grpcUrl: 'terra-classic-grpc.publicnode.com',
        path: "m/44'/330'/0'/0/0",
        coinDecimals: 6,
        chainId: 'columbus-5',
        denom: 'uluna',
